...
#import "WindowCtrl_Picture_3DGameFaceStylizing.h"
...
@interface WindowCtrl_Picture_3DGameFaceStylizing ()
...
@implementation WindowCtrl_Picture_3DGameFaceStylizing
        ...
        for (int f = 0; f < faceMaskDataArr.imgsNum; f++) {
            ...
            [self.mtkView renderRectTextureToBackground_With_MTLCommandBuffer:mtlCmdBuff
                                                                  rectTexture:_mtltexture_FaceArr[f]
                                                                      rectBox:mtl_rect
                                                             offScreenTexture:self.mtkView.mtltexture_frontground
                                                                  clearScreen:f == 0];
        }
