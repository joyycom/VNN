...
#import "WindowCtrl_Picture_PoseLandmarkDetection.h"
...
@interface WindowCtrl_Picture_PoseLandmarkDetection ()
@property (nonatomic, assign) unsigned int mHandle;
@end

@implementation WindowCtrl_Picture_PoseLandmarkDetection
...
- (void)processPictureBuffer:(CVPixelBufferRef)pixelBuffer URL:(NSURL *)url {
    ...
    [self.mtkView drawSolidLine2DToOffscreen_With_MTLCommandBuffer:mtlCmdBuff
                                                           Line2Ds:lines
                                                  offScreenTexture:self.mtkView.mtltexture_offScreenImage
                                                       clearScreen:false];
