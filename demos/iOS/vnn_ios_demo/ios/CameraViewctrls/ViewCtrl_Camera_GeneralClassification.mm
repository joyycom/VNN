...
#import "ViewCtrl_Camera_GeneralClassification.h"
...
@interface ViewCtrl_Camera_GeneralClassification ()
...
@implementation ViewCtrl_Camera_GeneralClassification
            ...
            for(int i = 0; i < face_data.facesNum; i++){
                ...
                [self.glUtils rectsDrawer]->_rects.emplace_back(
                                                                vnn::renderkit::DrawRect2D(
                                                                                             ...
                                                                                             3.f,                                // thickness
                                                                                           vnn::renderkit::DrawColorRGBA(r, g, b, 1.f)
                                                                                             )
                                                                );
            }
